...
SRC_DIRS := src src/SDK/OS src/SDK/EXI src/SDK/SI src/SDK/DB src/SDK/VI src/SDK/MTX \
            src/SDK/GX src/SDK/DVD src/SDK/AI src/SDK/AX src/SDK/MEM src/SDK/MIX src/SDK/base \
...
ASM_DIRS := asm asm/SDK/OS asm/SDK/EXI asm/SDK/SI asm/SDK/DB asm/SDK/VI asm/SDK/MTX \
            asm/SDK/GX asm/SDK/DVD asm/SDK/AI asm/SDK/AX asm/SDK/MEM asm/SDK/MIX asm/SDK/base \
